      ...
      <div class="login_content">
        ...
        <div class="login_input">
          <div class="inputArea idArea">
            <!-- <img src="img/icon_user.png" alt="아이디 아이콘"/ class="icon"> -->
            <input type='text' name="user_id" value="" placeholder="아이디" required maxlength="30" minlength="8"  class='user_id' autocomplete="off"/>
          </div>
          <div class="inputArea pwArea">
            <!-- <img src="img/icon_pwd.png" alt="패스워드 아이콘"/ class="icon"> -->
