                        ...
                        <dl class="coinSelect">
                            <dt><a href="#" title="이더리움"><img src="img/eth.png" alt="이더리움"/></a><span>이더리움 ETH/KRW</span>
                              ...
                              <dd onclick="location.href='exchange_BITCOINCASH.php'"><a href="#" title="비트코인캐시"><img src="img/bitcoincash.png" alt="비트코인캐시"/></a><span>비트코인캐시 BCH/KRW</span>
                                <img src="img/usa-31-sq.png" alt="국기" class="flag"></dd>
                              <dd onclick="location.href='#'"><a href="#" title="이더리움"><img src="img/eth.png" alt="이더리움"/></a><span>이더리움 ETH/KRW</span>
...
<!-- 코인상세보기 끝 ------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div id="full_second">
        ...
        <div id='apply_buy_popup' class='popup box'>
            <div class="full_inner">
                <h2>매수주문</h2>
                <p><span class='emphasis'>1,000 KRW</span>로 <span class='emphasis'>10 ETH</span>를 매수합니다.</p>
        ...
        <div id='apply_sell_popup' class='popup box'>
            <div class="full_inner">
                <h2>매도주문</h2>
                <p><span class='emphasis'>10 ETH</span>판매 후 <span class='emphasis'>1,000 KRW</span>를 수령합니다.</p>
                <input type="button" name="confirm" value="취소" class='popupbt cancel'>
