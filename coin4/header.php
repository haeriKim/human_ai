        ...
        <div class="current_coin">
          <ul>
            ...
            <li class='bth'>
              ...
              <p><span class="current_pri">481,400</span> KRW</p>
              <b class="down"><span class="current_per">- 0.23</span> %</b>
            </li>
            <li class='eth'>
              <span>이더리움(ETH)</span>
            ...
            <li class='etc'>
              ...
              <p><span class="current_pri">10,190</span> KRW</p>
              <b class="down"><span class="current_per">- 0.20</span> %</b>
            </li>
            <li class='eos'>
              <span>이오스(EOS)</span>
              <p><span class="current_pri">5,965</span> KRW</p>
              <b class="down"><span class="current_per">- 0.68</span> %</b>
            </li>
            <li class='xrp'>
              <span>리플(XRP)</span>
              <p><span class="current_pri">517</span> KRW</p>
              <b class="down"><span class="current_per">- 0.19</span> %</b>
            </li>
            <li class='ada'>
              <span>에이다(ADA)</span>
