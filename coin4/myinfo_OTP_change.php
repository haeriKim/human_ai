                    ...
                    <div class="myinfo_main_box cer_center mypage_content">
                      ...
                      <h4>OTP 비활성화</h4>
                        ...
                        <div class="myinfo_text_box">
                          <br/>
                          <p><span>OTP 비활성화 시</span> 보안상 중대한 위협을 초래할 수 있습니다. 이에 따라 OTP를 등록하지 않은</p>
                          <br/>
                          <p>고객은 <span>거래, 입출금</span> 등의 서비스 이용이 제한됩니다. 부득이한 경우 <span>(휴대폰 교체로 인한 임시적 해제 등)</span>에만<br/>
                          <br/>
                          <span>OTP 비활성화 과정</span>을 진행하시기 바랍니다. 비활성화를 하시겠습니까?</p>
                          <br/>
                        ...
                        <div class="cancel_or_apply">
                          ...
                          <input type="button" name="" value="비활성화" class="agree_btn" onclick="location.href='myinfo_OTP_change_step1.php'">
                        </div>
