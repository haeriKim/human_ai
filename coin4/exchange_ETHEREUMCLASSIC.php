                    ...
                    <div class="coinSelect_area">
                        <dl class="coinSelect">
                            <dt><a href="#" title="이더리움클래식"><img src="img/etc.png" alt="이더리움클래식"/></a><span>이더리움클래식 ETC/KRW</span>
                              ...
                              <dd onclick="location.href='#'"><a href="#" title="이더리움클래식"><img src="img/etc.png" alt="이더리움클래식"/></a><span>이더리움클래식 ETC/KRW</span>
                                <img src="img/sws-31-sq.png" alt="국기" class="flag"></dd>
...
<!-- 코인상세보기 시작 ------------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="box coin_money_detail coin_money_ethuriumClassic">
          <div class="coin_name"><h4>Ethereum Classic</h4></div>
        <div id="detail_all">
...
<!-- 코인상세보기 끝 ------------------------------------------------------------------------------------------------------------------------------->
              ...
              <form class="buy_tab_form" action="#" method="post" name='buy_tab_form'>
                  ...
                  <div class="buy_tab_content box">
                      ...
                      <div class="mini_sub_info">
                          <span class='sub_text minimum_order_price'>최소주문수량 : 0.1 ETC</span>
    ...
    <div id="full_second">
        ...
        <div id='apply_buy_popup' class='popup box'>
            <div class="full_inner">
                <h2>매수주문</h2>
                <p><span class='emphasis'>1,000 KRW</span>로 <span class='emphasis'>10 ETC</span>를 매수합니다.</p>
        ...
        <div id='apply_sell_popup' class='popup box'>
            <div class="full_inner">
                <h2>매도주문</h2>
                <p><span class='emphasis'>10 ETC</span>판매 후 <span class='emphasis'>1,000 KRW</span>를 수령합니다.</p>
                <input type="button" name="confirm" value="취소" class='popupbt cancel'>
