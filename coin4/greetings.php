                  ...
                  <div class="box greetings_area">
                      ...
                      <div class="greetings_inner">
                        ...
                        <div class="greetings_story">
                          ...
                          <br/>
                          <p>그러므로 코인등급제도를 실시할 예정입니다. 디올스 국제거래소에서 등급을 받지 않는 코인은 실생활에 어려울 것으로 보입니다.</p><br/>
                          ...
                          <br/>
                          <p>여 섯째” 블록체인은 변조가 어렵지 해킹이 가능하다는 사실.</p>
                          <br/>

                          <p><b>그러나 여기에는</b></p>
                          <br/>
                          <p><b>첫 번째</b>” 현실의 꿈을 이루고 후대에 남겨야 할 우리의 자산이 여기에 있다는 사실.</p>
                          <br/>
                          <p><b>두 번째</b>” 블록체인의 수뇌가 모여 있는 것도 사실.</p>
                          <br/>
                          <p><b>세 번째</b>” 보안이 완벽하여 해킹을 방지할 수 있는 곳도 사실이며, 특히 어느 공공기관 및 사업체의 보안이 필요한 곳은 언제든지 저희 기술력으로 가능합니다.</p>
                          <br/>
                          <p><b>네 번째</b>” 기축통화를 부르짓고 있는 모든 인류의 사람들이 모인 곳도 사실.</p>
                          <br/>
                          <p><b>다 섯째</b>” 잘못된 코인을 만들어 백서와 오픈소스가 맞지 않아 상장을 못하는 업체에 코인과 백서를 만들어 드립니다.</p>
                          <br/>
                          ...
                          <br/>
                          <p>아직도 부족하고 가야 할 길이 멀고도 먼 길입니다. 하지만 정신적 지주가 우리 가족회원님들이 도와 주신다면 얼마든지 해결하고 전진해 갈 수가 있으므로 앞뒤에서 저희를 믿고 따라주시면 감사하겠습니다. </p>
                          <br/>
                          <p>세계 인류 하 나의 기축통화 코인을 위해 디올스 국제거래소는 노력 할 것입니다. 모두가 행복하시길 기원합니다.</p>
                          <br/>
                          <p>주) 디올스 회장 최 기 재외 임직원 일동</p>
                          <br/>
                          <p>www.Thealls.net , 한글 디올스.net</p>
