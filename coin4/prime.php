...
<body>
    ...
    <div id="wrap">
        ...
        <div id="container">
            ...
            <div class="content_wrap2">
                ...
                <div class="con_top" id="content">
                  ...
                  <div class="box prime_area">
                      ...
                      <div class="prime_inner"><!--prime_inner-->
                          ...
                          <div class="prime_value"><!--프라임벨류-->
                            <div class="theallsprime_icon">
                              ...
                              <div class="theallsprime_number">
                                <ul>
                                  <li>
                                    <img src="img/trust.png" alt="프라임" class="right_img">
                                    <b>The Alls Value<span> 01</span></b>
                                    <p>인격에 믿음과 신뢰가 있다.</p>
                                    <span>There is faith and trust in personality.</span>
                                  </li>

                                  <li><img src="img/life.png" alt="프라임" class="left_img">
                                    <b>The Alls Value<span> 02</span></b>
                                    <p>상대가 살아야 내가 살 수 있다.</p>
                                    <span>I can live if my opponent lives.</span>
                                  </li>

                                  <li><img src="img/lnitial.png" alt="프라임" class="right_img">
                                    <b>The Alls Value<span> 03</span></b>
                                    <p>초심을 잊어서는 안된다.</p>
                                    <span>You should not forget your initials.</span>
                                  </li>

                                  <li><img src="img/think.png" alt="프라임" class="left_img">
                                    <b>The Alls Value<span> 04</span></b>
                                    <p>생각은 매일 변화 된다. 그러므로 알아야한다.</p>
                                    <span>Thoughts change every day. Therefore, we should know.</span>
                                  </li>

                                  <li><img src="img/development.png" alt="프라임" class="right_img">
                                    <b>The Alls Value<span> 05</span></b>
                                    <p>끊임없는 기술 발전에 노력한다.</p>
                                    <span>We strive for continuous technological development.</span>
                                  </li>
                          ...
                          <div class="prime_service"><!--프라임서비스-->
                            <div class="theallsprime_icon2">
                              <p><img src="img/prime_point.png" alt="프라임아이콘"></p>
                              <h3>S E R V I C E</h3>
                              ...
                              <div class="service_text">
                                <p class="st1"><span>Service01</span><br/>'디올스 국제거래소'는 해킹에 완벽하고 기축통화가 될 수 있도록 만들었습니다.<br/>
                                <small>* 기축통화 : 금과 더불어 국제간 결제나 금융거래에서 통용되는 통화를 가리킵니다. 대표적으로 미국의 달러가 이러한 기축통화 입니다.</small></p>
            ...
            <div class="main_top">
              <a href="index.php"><img src="img/top.png" alt="탑버튼"></a>
            </div>
...
<!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- -->
<!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- -->
<!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- --><!-- 반응형 시작- -->
                      ...
                      <div class="prime_inner"><!--prime_inner-->
                          ...
                          <div class="prime_value"><!--프라임벨류-->
                            <div class="theallsprime_icon">
                              ...
                              <div class="theallsprime_number1">
                                <ul>
                                  <li class="value_letter">
                                    <span>
                                      <b>The Alls Value<span> 01</span></b>
                                      <p>인격에 믿음과 신뢰가 있다.</p>
                                      <span>There is faith and trust in personality.</span>
                                  ...
                                  <li class="value_img"><img src="img/trust.png" alt="프라임"></li>
                                  ...
                                  <li class="value_img"><img src="img/life.png" alt="프라임"></li>
                                  ...
                                  <li class="value_img"><img src="img/lnitial.png" alt="프라임"></li>

                                  <li class="value_letter">
                                    <span>
                                      <b>The Alls Value<span> 04</span></b>
                                      <p>생각은 매일 변화 된다.</p><p> 그러므로 알아야한다.</p>
                                      <span>Thoughts change everyday.<br/>Therefore, we should know.</span>
                                    </span>
                                  </li>

                                  <li class="value_img"><img src="img/think.png" alt="프라임"></li>
                                  ...
                                  <li class="value_img"><img src="img/development.png" alt="프라임"></li>
                          ...
                          <div class="prime_service"><!--프라임서비스-->
                            <div class="theallsprime_icon2">
                              <p><img src="img/prime_point.png" alt="프라임아이콘" style="display: none;"></p>
                              <h3>S E R V I C E</h3>
                              <p class="prime_text">암호화폐의 새로운 기준 <b>'디올스 국제거래소'</b>의<br/> 요점은 이렇습니다.</p>
                              <ul class="prime_ul01">
                                <li><strong class="ss1">The Alls Service<b> 01</b></strong><span class="b_box b_box1"><p class="more">더보기</p></span></li>
                              </ul>

                                <div class="service_01">
                                  <p class="st1 st_text">'디올스 국제거래소'는 해킹에 완벽하고 기축통화가<br/> 될 수 있도록 만들었습니다.</p>
                                </div>

                              <ul class="prime_ul02">
                                <li><strong class="ss2">The Alls Service<b> 02</b></strong><span class="b_box b_box2"><p class="more">더보기</p></span></li>
                              </ul>

                                <div class="service_02">
                                  <p class="st2 st_text">'디올스 국제거래소'에 상장되는 모든 코인은 실시간<br/> 가격으로 사용이 가능하고,
                                  전자상거래 및 QR코드를 활용하여 직접 제품 주인에게 현금이 통장으로 입금됩니다.</p>
                                </div>

                              <ul class="prime_ul03">
                                <li><strong class="ss3">The Alls Service<b> 03</b></strong><span class="b_box b_box3"><p class="more">더보기</p></span></li>
                              </ul>

                                <div class="service_03">
                                  <p class="st3 st_text">상장기반 코인은 디올스,비트코인,비트코인캐시,이더리움,이더리움클래식,에이다,리플,이오스 입니다.</p>
                                </div>

                            </div>

                            <div class="theallsprime_number2">
                                    <div class="app_company1">
                                      <ul>
                                        <li class="title_li"><img src="img/exchange1.png" alt="거래소이미지">
                                            <p>기존 거래소</p>
                                        </li>
                                  ...
                                  <!--  <p class="left_text"><strong>타 거래소</strong></p><br/>
                                    ...
                                    <div class="app_company2">
                                      <ul>
                                        ...
                                        <li class="none_li"><span>[QR코드] QR코드를 활용한 오프라인에서도 포인트가 아닌 실시간 코인가격으로 사용가능</span></li>
                                        <li class="down_arrow">↓</li>
                                        <li class="none_li"><span>[현금화] 디올스 코인이 현금화 되어 매도자 또는 제품주인 통장으로 현금이 입금됨</span></li>
                                      </ul>
                          ...
                          <div class="prime_join"><!--프라임조인-->
                            <div class="theallsprime_icon3">
                              <p><img src="img/prime_free.png" alt="프라임조인"  style="display: none;"></p>
                              <h3>J O I N</h3>
                              <p class="prime_text">회원등록 한 번으로 <b>'디올스 국제거래소'</b>에 등록된<br/> <b>모든 코인</b>을 거래 할 수 있습니다.</p>
                                ...
                                <div class="theallsprime_number3">
                                  <div class="join_inner">
                                    <div class="join_box">
                                      <p>회원가입 시 디올스에서 제공되는 <b>비트코인,비트코인캐시,이더리움,이더리움클래식,이오스,리플,에이다,레드엔젤,필립스,c3</b>
                                      코인을 모두 이용할 수 있으며 타 거래소와 거래도 가능합니다.</p>
                                    </div>
                                  </div>
                                  ...
                                  <div class="join_img">
                                    ...
                                    <p class="join_img_fence">
                                      ...
                                      <span><b>디올스 국제거래소를 활용한 블록체인 오프라인 QR코드 결재 방법이란?</b><br/>
                                      <br/>
                                      프랜차이점, 백화점, 일반가게 등에서 결재 시 현금, 카드 대신 사용하여
                                      제품 가격을 현금으로 처리되는 것을 말합니다.<br/>
                                      <br/>
                                      즉 카드 수수료 없이 직접 현금으로 처리되는 것 입니다.<br/>
                                      <br/>
                                      따라서 디올스 국제거래소에서는 포인트가 아닌 실제 코인 가격이 실시간 가격에 따라
                                      그 가격으로 거래가 되는 프로그램입니다.
                                      </span>
                                    </p>
                                  </div>
                          ...
                          <div class="prime_method"><!--프라임메소드-->
                            <div class="theallsprime_icon4">
                              <p><img src="img/prime_money.png" alt="프라임아이디어" style="display: none;"></p>
                              <h3>M E T H O D</h3>
                              <p class="prime_text"><b>'디올스 국제거래소'</b>에 등록한 회원분들께<br/> 지갑을 직접 생성하여 지급해드립니다.</p>
                                ...
                                <div class="theallsprime_number4">
                                  ...
                                  <div class="wallet_box">
                                    <p>지갑은 실제 사용하는 <span class="red">빨강색지갑</span>과 에어드랍을 받는 <span class="yellow">노랑색지갑</span> 그리고 어드바이저 등에게 지급하는
                                    <span class="blue">청색지갑</span>으로 구분되어 코인사가 원할 경우 분할하여 지급됩니다. (같은 색상의 지갑과는 연동이 가능합니다.)</p>
                                  </div>
                                  </div>
                                  <colgroup>
                                    <col width="30%">
                                    ...
                                    <table>
                                      <tr>
                                        <th><img src="img/wallet_r2.png" alt="빨강지갑"></th>
                                        <td style="color:#f00;">실제 사용하는 지갑</td>
                                      </tr>

                                      <tr>
                                        <th><img src="img/wallet_y2.png" alt="노랑지갑"></th>
                                        <td style="color:#ada20b;">에어드랍을 받는 지갑</td>
                                      </tr>

                                      <tr>
                                        <th><img src="img/wallet_b2.png" alt="파랑지갑"></th>
                                        <td style="color:#00f;">어드바이저에게 지급하는 지갑</td>
                                      </tr>
                                    </table>
                          ...
                          <div class="prime_platform"><!--프라임플랫폼-->
                            <div class="theallsprime_icon5">
                              <p><img src="img/prime_platform.png" alt="프라임플랫폼" style="display: none;"></p>
                              <h3>P L A T F O R M</h3>
                              <p class="prime_text"><b>'디올스 국제거래소'</b>는 안전한 거래를 위한<br/> 플랫폼을 준비 합니다.</p>
                          ...
                          <div class="prime_security"><!--프라임 보안-->
                            <div class="theallsprime_icon6">
                              <p><img src="img/prime_security.png" alt="프라임아이디어" style="display: none;"></p>
                              <h3>S E C U R I T Y</h3>
                              <p class="prime_text"><span><b>'디올스 국제거래소'</b>는 철저한 보안서버를 바탕으로<br/> 고객서비스에 최선을 다하겠습니다.</p>
                            </div>
                          ...
                          <div class="history"><!--프라임 히스토리-->
                            <div class="theallsprime_icon7">
                              <p><img src="img/prime_step.png" alt="프라임아이디어" style="display: none;"></p>
                              <h3>H I S T O R Y</h3>
                              <p class="prime_text"><b>'대한민국 암호화폐 마켓의 기준'</b>을 넘어서<br/> 세계로 나아가겠습니다.</p>
                            </div>
                              <div class="theallsprime_number7">
                                <div class="history_inner">
                                  <div class="history_box">
                                    <p><img src="img/m_info_history.png" alt="히스토리이미지"></p>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="main_footer">
                            <div class="theallsprime_icon8">
                              <p><img src="img/prime_gift.png" alt="디올스로고" style="display: none;"></p>
                              <h3>T H A N K &nbsp;Y O U</h3>
                              <p class="prime_text"><b>세계 기축통화 암호화폐 '디올스 국제거래소'를<br/> 이용해주셔서 감사합니다.</b></p>
                              <input type='button' name="메인버튼" value="메인으로" onclick="location.href='index.php'" class="main_button">
                            </div>
                            <!--<img src="img/logo.png" alt="디올스로고">-->
