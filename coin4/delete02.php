                ...
                <div class="content exchange_content con_1290">
                  ...
                  <div class="box coin_select">
                    ...
                    <div class="coinSelect_area">
                        <dl class="coinSelect">
                            <dt><img src="img/eth.png" alt="이더리움"/><span>이더리움 ETH/KRW</span>
                              <img src="img/sws-31-sq.png" alt="국기" class="flag"></dt>
                            <dd onclick="location.href='exchange.php'"><img src="img/bitcoin.png" alt="비트코인"/><span>비트코인 BTC/KRW</span>
                              <img src="img/usa-31-sq.png" alt="국기" class="flag"></dd>
                            <dd onclick="location.href='delete01.php'"><img src="img/bitcoincash.png" alt="비트코인캐시"/><span>비트코인캐시 BCH/KRW</span>
                              <img src="img/usa-31-sq.png" alt="국기" class="flag"></dd>
                            <dd onclick="location.href='delete02.php'"><img src="img/eth.png" alt="이더리움"/><span>이더리움 ETH/KRW</span>
                              <img src="img/sws-31-sq.png" alt="국기" class="flag"></dd>
                            <dd onclick="location.href='delete03.php'"><img src="img/etc.png" alt="이더리움클래식"/><span>이더리움클래식 ETC/KRW</span>
                              <img src="img/sws-31-sq.png" alt="국기" class="flag"></dd>
                            <dd onclick="location.href='delete04.php'"><img src="img/eos.png" alt="이오스"/><span>이오스 EOS/KRW</span>
                              <img src="img/hk-31-sq.png" alt="국기" class="flag"></dd>
                            <dd onclick="location.href='delete05.php'"><img src="img/reaple.png" alt="리플"/><span>리플 XRP/KRW</span>
                              <img src="img/usa-31-sq.png" alt="국기" class="flag"></dd>
                            <dd onclick="location.href='delete06.php'"><img src="img/ada.png" alt="에이다"/><span>에이다 ADA/KRW</span>
                              <img src="img/sws-31-sq.png" alt="국기" class="flag"></dd>
                        </dl>
                    </div>
                  </div>
