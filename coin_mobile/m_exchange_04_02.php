...
<head>
  ...
  <link rel="stylesheet" href="css/exchange33.css">
                ...
                <form class="" action="#" method="post">
                    <div class="not_yet_deal_content_wrap">
                        <div class="not_yet_deal_content">
                            <input type="checkbox" name="check" value="check" id='check1'>
                        ...
                        <div class="not_yet_deal_content">
                            <input type="checkbox" name="check" value="check" id='check2'>
