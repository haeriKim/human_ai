                      ...
                      <div class="box coinInfo_area">
                        ...
                        <div class="text_area">
                          <div>
                            <h4>코인소개</h4>
                            <p>
                              이오스(EOS) 암호화폐는 탈 중앙화 컴퓨터, 모바일, 어플 통신 개발 운영체제이며, 수백만개에 달하는 거래를 빠르게 처리가 가능하고 이러한 운영체제 속에서 확장하고 유연하게 매우 안전하게 개발할 수 있습니다.<br/>
                              <br/>
                              Bitshare와 Steem을 개발한 댄라리머(Dan Larimer)가 2017년 6월 개발한 DApp플랫폼으로, 기술적 측면은 이더리움과 비슷하나, 기존 플랫폼의 비싼 수수료와 연산 능력의 한계로 블록체인의 광범위한 사용이 어렵기 때문에 개발자 및 사용자가 무료로 이용할 수 있는 플랫폼을만들어졌습니다.<br/>
                          ...
                          <div>
                            <h4>코인 특징</h4>
                            <p>
                              1. 블록 타임 DPOS의 합의 방식을 채택한 이오스는 0.5초마다 블록이 생성됩니다. 비트쉐어와 스팀에 사용된 그래핀 압의 엔진보다 6배나 개선된 것이며 이를 위해 기술적으로 현실의 벽과 타협하긴 했지만
                              이런 타협을 통해서 이오스는 Dapp의 사용자에게 여태껏 플랫폼 블록체인이 제공하지 못한 빠른 속도의 서비스를 제공할 수 있게되었습니다.<br/>
                              ...
                              <br/>
                              3. EOS는 블록체인이 철학적으로 추구하는 이상 (완벽한 탈중화)를 고집하지 않고 어느정도 현실성과 타협함으로 인해 현실성 있는 탈중앙화 기반의 서비스, 단체, 집단 등을 창출해내고 있습니다.<br/>
                              이부분을 높게 살수밖에 없는 이유는 EOS의 빠른 실행력입니다.EOS는 블록체인이 추구하는 탈중앙화 시스템의 철학을 지키면서도 지금 시대에 그 가치를 가장 현실성있게 눈으로 보여줄 수 있는 기술입니다.<br/>
