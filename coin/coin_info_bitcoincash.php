                    ...
                    <div class="content coninInfo_content con_1250">
                        <div class="box coin_select">
                          ...
                          <div class="coinSelect_area">
                              <dl class="coinSelect">
                                  <dt><a href="#" title="비트코인캐시"><img src="img/bitcoincash.png" alt="비트코인캐시"/></a><span>비트코인캐시 BCH/KRW</span></dt>
                      ...
                      <div class="box coinInfo_area">
                        ...
                        <div class="text_area">
                          <div>
                            <h4>코인소개</h4>
                            <p>
                              비트코인캐시는 최초로 구현된 가상화폐입니다. 발행 및 유통을 관리하는 중앙권력이나 중간상인 없이, P2P 네트워크 기술을 이용하여 네트워크에 참여하는 사용자들이 주체적으로 화폐를 발행하고 이체내용을 공동으로 관리합니다. 이를 가능하게 한 블록체인 기술을 처음으로 코인에 도입한 것이 바로 비트코인입니다.<br/><br/>
                          ...
                          <div>
                            ...
                            <p class='link_bitcoin_cash'>
                              ...
                              <a href="" title="비트코인 포럼">비트코인캐시 포럼</a>
                              <a href="" title="비트코인 채굴">비트코인캐시 채굴</a>
                            </p>
                          </div>
                          <div>
                            <h4>코인 특징</h4>
