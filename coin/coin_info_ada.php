                    ...
                    <div class="content coninInfo_content con_1250">
                        <div class="box coin_select">
                          ...
                          <div class="coinSelect_area">
                              <dl class="coinSelect">
                                  <dt><a href="#" title="에이다"><img src="img/ada.png" alt="에이다"/></a><span>에이다 ADA/KRW</span></dt>
                      ...
                      <div class="box coinInfo_area">
                        ...
                        <div class="text_area">
                          <div>
                            <h4>코인소개</h4>
                            <p>
                                에이다 코인은 기존 암호화폐들의 장점은 흡수하고 이더리움의 단점을 보완한 탈중앙화 스마트 컨트랙트 플랫폼 코인입니다. 해외에서는 에이다 코인을 흔히 이더리움 킬러라고도 많이 부릅니다. 그 이유는 이더리움을 처음으로 개발했던 개발자중 한명인 Charles Hoskinson이 에이다 코인을 만들었기 때문에 사람들은 그가 이더리움을 개발할때 얻은 지식과 경험들로 더 좋은 플랫폼을 만들수있다는 기대로 이더리움 킬러라고 부르고 있습니다.<br><br>
                                에이다는 POS채굴 방식으로 초당 거래량이 다른 코인들보다 더 많고 훨씬 더 안전한 거래를 할 수 있는 장점이 있습니다. 이외에도 에이다 코인은 많은 기능과 확실한 목표를 가지고 있기때문에 전 세계적으로 관심을 받고 있습니다.
                            </p>
                          </div>
                          <div>
                            <h4>상용링크</h4>
                          ...
                          <div>
                            <h4>코인 특징</h4>
                            <p>
                                1. 에이다 프로그래밍 언어 중 가장 난해하면서도 높은 안정성으로 평가받고있는 함수형 언어인 하스켈(Haskel)로 구축되었습니다. 하스켈로 구축된 프로그램은 앞으로 5년후 나올것이라는 양자컴퓨터의 등장에도 해킹에 안전할 수 있는 언어입니다.<br><br>
