        ...
        <div id="container">
            ...
            <div class="content_wrap">
                ...
                <div class="content coninInfo_content con_1250">
                  ...
                  <!--coin_money-->
                  <div class="box price_info">
                    <div class="cur_price">
                      <img src="img/bitcoin_big.png" alt="비트코인아이콘" class="bitcoin_icon">
                      <ul>
                        <li><strong>비트코인</strong><b class="coin_word">BTC/KRW</b></li>
                        <li><span class="price">7,400,000<b class="won">KRW</b></span></li>
                        <li><b>전일대비</b><span class="prepare">-0.31%</span><span class="updownarrow">▼23,000</span></li>
                      </ul>
                    </div>
                  </div><!--coin_money End-->
