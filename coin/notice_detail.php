        ...
        <div id="container">
          ...
          <!-- header_wrap End-->
            ...
            <div class="content_wrap">
                <!-- notice_detail_wrap -->
                <div class="content notice_detail_wrap con_1000">
                  <!-- notice_detail -->
                            ...
                            <ul class="notice_preview">
                                <li class='prev_notice_title'>
                                    <a href='#'>
                                        ...
                                        <p>[거래] 원화 마켓 신규 상장(베이직어텐션토큰 BAT, 애드엑스 ADX, 애드토큰 ADT)</p>
                                    </a>
                                </li>
                                <li class='next_notice_title'>
                                    <a href='#'>
                                        <p class='next_img'>다음글</p>
                                        <p>[입출금] 월렛 업그레이드 6차 완료(신규 입금 주소 발급 필요한 암호화폐 확인 필수)</p>
                                    </a>
                                </li>
                            </ul>
                        </div>
