          ...
          <!--  <div class="ai_tech_content">
            ...
            <div id="te_intro_kind" class="tech_content_wrap target">
                ...
                <ul>
                    ...
                    <li><a href="#" class="hvr-underline-from-left"><div class="on_line2"></div>인공지능 보안사업</a></li>
                    <li><a href="#" class="hvr-underline-from-left"><div class="on_line3"></div>AI적용 영어 동화 대화 시스템</a></li>
                </ul>
